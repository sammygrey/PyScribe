    ...
    def list_working_microphones():
        ...
        try:
            ...
            for device_index in range(audio.get_device_count()):
                ...
                debiased_energy = rms(add(buffer, energy_bytes * (len(buffer) // 2), 2), 2)
...
class Recognizer(AudioSource):
    ...
    def adjust_for_ambient_noise(self, source, duration=1):
        ...
        while True:
            ...
            energy = rms(buffer, source.SAMPLE_WIDTH)  # energy of the audio signal
    ...
    def _listen(self, source, timeout=None, phrase_time_limit=None, snowboy_configuration=None, stream=False):
        ...
        while True:
            ...
            while True:
                ...
                energy = rms(buffer, source.SAMPLE_WIDTH)  # unit energy of the audio signal within the buffer
